...
// node_modules/@cloudscape-design/component-toolkit/mjs/internal/base-component/validate-props.js
...
var Theme;
(function(Theme2) {
  Theme2["VisualRefresh"] = "visual-refresh";
  Theme2["OneTheme"] = "one-theme";
})(Theme || (Theme = {}));
var THEMES = {
  [Theme.VisualRefresh]: {
    ...
    isFlagActive: () => {
      var _a2, _b;
      return !!((_b = (_a2 = getGlobal()) === null || _a2 === void 0 ? void 0 : _a2[awsuiVisualRefreshFlag]) === null || _b === void 0 ? void 0 : _b.call(_a2));
    }
  },
  [Theme.OneTheme]: {
...
function Portal({ container, getContainer, removeContainer, children }) {
  ...
  if (!activeContainer && typeof document !== "undefined") {
    return import_react10.default.createElement("span", { ref, style: { display: "none" } });
  }
...
var PACKAGE_VERSION = "3.0.0 (12fae2db)";
var GIT_SHA = "12fae2db";
...
var useOneTheme = () => isThemeActive(Theme.OneTheme);
...
import "/Users/divyadharshini/Documents/Python/StockVision-AI/frontend/node_modules/@cloudscape-design/components/internal/base-component/styles.scoped.css";
...
//# sourceMappingURL=chunk-G6NP7Q4A.js.map
