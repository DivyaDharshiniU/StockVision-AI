...
import "/Users/divyadharshini/Documents/Python/StockVision-AI/frontend/node_modules/@cloudscape-design/components/header/analytics-metadata/styles.scoped.css";
...
function InternalHeader({ variant, headingTagOverride, children, actions, counter, description, info, __internalRootRef, __disableActionsWrapping, __headingTagRef, __headingTagTabIndex, ...restProps }) {
  ...
  return import_react2.default.createElement(
    "div",
    { ...baseProps, className: clsx_m_default(styles_css_default.root, baseProps.className, styles_css_default[`root-variant-${variantOverride}`], isRefresh && styles_css_default.refresh, !actions && [styles_css_default[`root-no-actions`]], description && [styles_css_default[`root-has-description`]]), ref: __internalRootRef },
    import_react2.default.createElement(
      ...
      import_react2.default.createElement(
        ...
        import_react2.default.createElement(
          HeadingTag,
          { className: clsx_m_default(styles_css_default.heading, styles_css_default[`heading-variant-${variantOverride}`]), ref: __headingTagRef, tabIndex: __headingTagTabIndex, ...getAnalyticsLabelAttribute(`.${styles_css_default2["heading-text"]}`) },
          import_react2.default.createElement("span", { ...isInContainer ? { [DATA_ATTR_FUNNEL_KEY]: FUNNEL_KEY_SUBSTEP_NAME } : {}, className: clsx_m_default(styles_css_default["heading-text"], styles_css_default2["heading-text"], styles_css_default[`heading-text-variant-${variantOverride}`]), id: headingId }, children),
...
function Header({ variant = "h2", ...props }) {
  ...
  return import_react3.default.createElement(InternalHeader, { __headingTagTabIndex: tabIndex, variant, ...props, ...baseComponentProps });
}
