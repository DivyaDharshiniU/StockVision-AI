...
declare const EmbeddedMultiselect: React.ForwardRefExoticComponent<Pick<MultiselectProps, "onChange" | "ariaLabel" | "virtualScroll" | "onLoadItems" | "loadingText" | "errorText" | "recoveryText" | "deselectAriaLabel" | "statusType" | "controlId" | "options" | "empty" | "noMatch" | "filteringType" | "selectedOptions" | "finishedText"> & {
